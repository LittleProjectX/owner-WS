        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Silahkan memasukkan nomor telepon',
              ...
              SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (code != '0' && loginC.phone.text.isNotEmpty) {
                          authC.siginWithPhone('+${code + loginC.phone.text}');
                        } else {
                          Get.snackbar('Perhatian',
                              'Mohon untuk tidak mengosongkan Telepon');
                        }
                      },
                      child: const Text(
                        'VERIFIKASI',
